...
def get_oom(n):
    """
    Возвращает порядок числа, то есть логарифм модуля числа по основанию 10. Для маленьких по модулю чисел возвращает 0.
    :param n: Входное число.
    :return: Порядок числа.
    """
    return math.log10(abs(n)) if abs(n) >= 1e-3 else 0
